...
import { useSetDefaultTown } from '@/hooks/useTownMembership';
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {townsLoading ? (
            ...
            <>
              ...
              <Button type="submit" className="w-full" disabled={setDefaultTown.isPending || !selectedTownId}>
                {setDefaultTown.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                Continue
              </Button>
            </>
          )}
