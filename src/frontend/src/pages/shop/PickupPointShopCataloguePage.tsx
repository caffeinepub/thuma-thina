...
import { Search, ShoppingCart, Package, TrendingDown, ArrowLeft } from 'lucide-react';
    ...
    <div className="container-custom py-8">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <Button variant="ghost" onClick={() => navigate('/pickup-point-dashboard')} className="mb-2">
              <ArrowLeft className="mr-2 h-4 w-4" />
              Back to Dashboard
            </Button>
            <h1 className="text-3xl font-bold mb-2">Shop for Customer</h1>
            <p className="text-muted-foreground">Browse products and add items to the customer's order</p>
          </div>
          <div className="flex gap-2">
            <Button onClick={() => navigate('/pickup-point-cart')} variant="outline">
        ...
        <Alert>
          <AlertDescription>
            You are creating an order on behalf of a walk-in customer. Add items to cart and proceed to checkout.
          </AlertDescription>
        </Alert>
